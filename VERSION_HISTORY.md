...
- **P1-6 threshold drift** — aligned `phase3/v5/SPEC.md` (V5 SPEC, previously at repo root as `Hermem-V5-SPEC.md` before 2026-06-12 docs refactor) and constants in `config.py` to **HIGH=0.70, MEDIUM=0.50** (was MEDIUM=0.65 in the spec while 0.50 in code).
...
- **P1-10 docs status** — `v5.5/SPEC.md` now reads "已实现 v1.0 (2026-05-28)"; `v5.5/TODO.md` v1.1→v1.2 with score 8.5→9.5/10; `phase3/v5/SPEC.md` (V5, moved from repo root `Hermem-V5-SPEC.md` in 2026-06-12 docs refactor) marked "已实现 v5.1".
